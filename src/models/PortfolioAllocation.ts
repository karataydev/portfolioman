...
export const PortfolioAllocationModel = {
  ...
  async create(allocation: Omit<PortfolioAllocation, 'id'>): Promise<PortfolioAllocation> {
  ...
  async update(id: string, updates: Partial<PortfolioAllocation>): Promise<PortfolioAllocation> {
  ...
  async getPortfolioAllocations(portfolioId: string): Promise<PortfolioAllocation[]> {
    const allocations = await db.any<PortfolioAllocation>(
